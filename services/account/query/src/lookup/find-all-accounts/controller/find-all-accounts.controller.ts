import { ACCOUNT_QUERY_SERVICE_NAME, FindAllAccountsResponse, FindAllAccountsResponseData } from '@bank/sdk';
...
export class FindAllAccountsController {
  ...
  @GrpcMethod(ACCOUNT_QUERY_SERVICE_NAME, 'FindAllAccounts')
